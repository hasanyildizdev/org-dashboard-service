...
import type { UserEducation, UserEducationInput, UserExperience, UserExperienceInput } from '~/types/core_types'
...
// Load educations and experiences on mount (client-only)
onMounted(async () => {
